...
class OccludedClozeDeletion(CardManager):
    ...
    def _add_card(self, card_details):
        ...
        card = self.get_card_by_cloze_id(cloze_id) or Card()
    ...
    def get_card_by_cloze_id(self, cloze_id):
...
class FormattedOccludedClozeDeletion(OccludedClozeDeletion):
    Occluder = FormattedClozeOccluder